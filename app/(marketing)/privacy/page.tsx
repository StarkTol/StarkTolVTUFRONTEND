  ...
  return (
    <div className="container mx-auto max-w-4xl py-12">
      ...
      <div className="prose prose-slate max-w-none dark:prose-invert">
        ...
        <h3>Personal Data</h3>
        <p>When you register for an account, we collect personally identifiable information, such as your:</p>
        <ul>
          <li>Name</li>
          <li>Email address</li>
          <li>Phone number</li>
        ...
        <p>We collect data related to your transactions on our platform, including:</p>
        <ul>
        ...
        <h2>6. Cookies and Other Tracking Technologies</h2>
        <p>
          We may use cookies, web beacons, tracking pixels, and other tracking technologies to help customize the
          website and improve your experience. When you access the website, your personal information is not collected
