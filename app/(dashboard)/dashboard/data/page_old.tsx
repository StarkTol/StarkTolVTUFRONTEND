...
export default function DataPage() {
  ...
  const { mutate: purchaseData, loading, error: purchaseError, success, data: purchaseData } = usePurchaseData()
